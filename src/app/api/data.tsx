...
{ title: "Более долговечно" },
{ title: "Проще в использовании" },
];
...
export const perksData: {
...
}[] = [
  {
    ...
    text: "Нужна помощь? Быстрое решение ваших запросов через службу поддержки.",
    space: "lg:mt-8",
  },
  {
  ...
  },
  {
    ...
    title: "Академия",
    text: "Изучай блокчейн <br />С Нами Бесплатно!.",
    space: "lg:mt-4",
  },
];
...
export const timelineData: {
  ...
  },
  {
    ...
    title: "Доработка",
    text: "Дорабатываем и улучшаем ваше решение",
    position: "md:top-0 md:right-0",
  },
  {
    icon: "/images/timeline/icon-prototype.svg",
    title: "Прототип",
    text: "Создаём рабочий прототип для тестирования продукта",
    position: "md:bottom-0 md:left-0",
  },
  {
    icon: "/images/timeline/icon-support.svg",
    title: "Поддержка",
    text: "Запускаем продукт и обеспечиваем полную поддержку",
