        ...
        <div className='grid lg:grid-cols-2 items-center gap-20'>
          ...
          <motion.div
            ...
            <p className='sm:text-28 text-18 text-muted mb-4'>
              Cryptocurrency <span className='text-primary'>Портфель</span>
            </p>
            <h2 className='text-white sm:text-40 text-30 mb-4 font-medium'>
              Создай Криптопортфель сегодня с РуКрипт
              <span className='text-primary'>Go</span>!
            </h2>
            <p className='text-muted/60 text-18'>
          РуКрипт предлагает множество возможностей, которые делают её одним из лучших решений.
              <br className='md:block hidden' /> Место для старта трейдинга.
            </p>
