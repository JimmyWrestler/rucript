      ...
      <div className='container px-4'>
        <div className='grid grid-cols-1 sm:grid-cols-12 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16'>
          <div className='lg:col-span-4 md:col-span-6 col-span-6'>
            ...
            <Link className='text-white text-24 font-medium sm:mt-20 mt-12 hover:text-primary' target='_blank' href=""></Link>
          </div>
          <div className='lg:col-span-2 md:col-span-3 col-span-6'>
            <h4 className='text-white mb-4 font-medium text-24'>Ссылки</h4>
            <ul>
          ...
          <div className='lg:col-span-2 md:col-span-3 col-span-6'>
            <h4 className='text-white mb-4 font-medium text-24'>Информация</h4>
            <ul>
          ...
          <div className='lg:col-span-4 md:col-span-4 col-span-6'>
            <h3 className='text-white text-24 font-medium'>Подписаться</h3>
            <p className='text-muted/60 text-18 mt-5'>
              Подпишитесь, чтобы получать
              <br /> свежие новости от нас
            </p>
